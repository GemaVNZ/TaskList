...
data class Task (var id: Int, var name: String, var done: Boolean = false, var archived : Boolean = false) {
        companion object {
            const val TABLE_NAME = "Tasks"
            const val COLUMN_NAME_TITLE = "name"
            const val COLUMN_NAME_DONE = "done"
            const val COLUMN_NAME_ARCHIVED_TASK = "archived"
            ...
            const val SQL_CREATE_TABLE =
                "CREATE TABLE $TABLE_NAME ("+
                        ...
                        "$COLUMN_NAME_ARCHIVED_TASK INTEGER)"
